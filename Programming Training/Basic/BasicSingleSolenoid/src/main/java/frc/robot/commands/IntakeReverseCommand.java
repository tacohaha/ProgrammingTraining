...
// Defines the class IntakeReverseCommand and inherits the Command classes included in Wpilib.
public class IntakeReverseCommand extends Command {
  // Constructor of IntakeReverseCommand
  ...
  protected void execute() {
    ...
    // It uses the setPercentOutput method we created and takes in a value of -1.0 (max percent out reverse)
